      ...
      <section className="bg-white">
        <div className="container py-4">
          <IntroSubLeaderboards
            title="Top Kill/Death Ratio Leaderboard"
            text="Bekijk hier de spelers met de hoogste Kill/Death ratio in Mario Maker 2!"
          />
        </div>
      </section>
      ...
      <section>
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h2 className="leaderboard-title mb-0">Highest K/D Ratio – All Players</h2>
            <button
          ...
          {users.map((player, index) => (
            <div key={player.pid} className="player-row-custom mb-2">
              ...
              <div className="playerPB">
                ...
                <div className="pb-value">{player.kdRatio.toFixed(3)}</div>
              </div>
            </div>
          ))}
        </div>
