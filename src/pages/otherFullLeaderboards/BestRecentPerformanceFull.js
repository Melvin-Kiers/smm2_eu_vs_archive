...
const BestRecentPerformanceFull = () => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        const sorted = [...data.users].sort(
          (a, b) => (b.recent_performance || 0) - (a.recent_performance || 0)
        );
      ...
      <section className="bg-white">
        <div className="container py-4">
          <IntroSubLeaderboards
            title="Recent Performance Leaderboard"
            text="Bekijk hier de spelers met de beste recente prestaties in Mario Maker 2!"
          />
        </div>
      </section>
      ...
      <section>
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h2 className="leaderboard-title mb-0">Recent Performance – All Players</h2>
            <button
...
export default BestRecentPerformanceFull;