    ...
    const fetchUsers = async () => {
      try {
        ...
        const sorted = [...data.users].sort(
          (a, b) => (b.versus_disconnected || 0) - (a.versus_disconnected || 0)
        );
      ...
      <section className="bg-white">
        <div className="container py-4">
          <IntroSubLeaderboards
            title="Most Disconnects Leaderboard"
            text="Bekijk hier de spelers met de meeste disconnects in Mario Maker 2!"
          />
        </div>
      </section>
      ...
      <section>
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h2 className="leaderboard-title mb-0">Most Disconnects – All Players</h2>
            <button
