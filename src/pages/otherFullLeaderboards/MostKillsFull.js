    ...
    const fetchUsers = async () => {
      try {
        ...
        const sorted = [...data.users].sort(
          (a, b) => (b.versus_kills || 0) - (a.versus_kills || 0)
        );
        setUsers(sorted);
      } catch (err) {
      ...
      <section className="bg-white">
        <div className="container py-4">
          <IntroSubLeaderboards
            ...
            text="Bekijk hier de spelers met de meeste kills in Mario Maker 2!"
          />
        </div>
      </section>
      ...
      <section>
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h2 className="leaderboard-title mb-0">Most Kills – All Players</h2>
            <button
