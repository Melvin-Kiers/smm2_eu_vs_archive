      ...
      <section className="bg-white">
        <div className="container py-4">
          <IntroSubLeaderboards
            ...
            text="Bekijk hier de spelers met de hoogste winrate in Mario Maker 2!"
          />
        </div>
      </section>
      ...
      <section>
        <div className="container py-4">
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h2 className="leaderboard-title mb-0">Top Winrate – All Players</h2>
            <button
