...
const TopDeathsLeaderboard = ({ players, totalPlayers }) => {
  ...
  return (
    <div className="mb-3 col-md-12">
      <h3 className="leaderboard-title mb-3">Most Killed by Others:</h3>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "1rem" }}>
        <button
          onClick={() => navigate("/other-leaderboards/top-deaths")}
